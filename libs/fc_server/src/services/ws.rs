...
use service::Server;
use crate::{copyer::{CopyService, PacketCleaner}, state::AppState, Error};
        ...
        async move
        {
            ...
            match &msg
            {
                ...
                Contract::CleanStart => 
                {
                    ...
                    let cp_service = state.get_copy_service();
                    cp_service.packets_cleaner.clean_packets(state).await;
                }
